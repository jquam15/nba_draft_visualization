...
percentile_plot = function(df, player) {
  ...
  ggplot(df, aes(x=Percentiles, y=Column, col=Percentiles)) +
    ...
    #set a black and white them
    theme(
      panel.border = element_rect(color = "#FDF7F7", fill=NA),
      plot.background = element_rect(fill = "#101010"),
      panel.background = element_rect(fill = "#101010"),
      panel.grid.major = element_line(color = "#FDF7F7"),
      panel.grid.minor = element_line(color = "#FDF7F7"),
      title = element_text(colour = "#FDF7F7", size=24),
      axis.title.x = element_text(colour="#FDF7F7"),
      axis.text.x = element_text(colour="#FDF7F7"),
      axis.text.y = element_text(colour="#FDF7F7"),
      axis.text = element_text(size=16),
      legend.text = element_text(colour="#FDF7F7"),
      legend.title = element_text(colour="#FDF7F7"),
      legend.background = element_rect(fill = "#101010")
    )
}

#Test example
percentile_plot(test, player)
```
